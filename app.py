...
st.markdown("""
    ...
    .section-header { color: #0f52ba; font-weight: bold; border-bottom: 2px solid #e9ecef; padding-bottom: 4px; margin-top: 15px; margin-bottom: 10px;}
...
with b1:
    ...
    <div class="card-box" style="border-left: 4px solid #fff3cd;">
        <h4 style="margin-top:0; margin-bottom:5px; color:#b58900; font-size:15px;">📦 Tank & Storage Sizing</h4>
...
with b2:
    ...
    <div class="card-box" style="border-left: 4px solid #f8d7da;">
        <h4 style="margin-top:0; margin-bottom:5px; color:#d9534f; font-size:15px;">🗺️ Array Field Configuration</h4>
...
with b3:
    ...
    <div class="card-box" style="border-left: 4px solid #d4edda;">
        <h4 style="margin-top:0; margin-bottom:5px; color:#5cb85c; font-size:15px;">🎛️ Automation & Controls Integration</h4>
        ...
        <span style="font-size:12px;">• <b>Controller:</b> Modulating differential logic PLC<br>
...
with chart_col2:
    ...
    # ☀️ Translated Math to calculate peak ground-level insolation intensity values in W/m²
    ...
    for n in day_numbers:
        ...
        # Atmospheric attenuation index transformation
    ...
    fig_radiation.update_layout(
        ...
        yaxis_title="Peak Design-Basis Insolation Intensity I (W/m²)",
        yaxis=dict(gridcolor='#e9ecef', range=[0, 1000]), # Strict 0-1000 W/m² display standard constraint
        plot_bgcolor='white', height=280, margin=dict(l=30, r=30, t=40, b=30)
    )
...
st.graphviz_chart(f"""
digraph G {{
    # Compact Blueprint Geometry Constraints
    size="12,4.5!";
    ratio="fill";
    rankdir=LR;
    splines=ortho;
    ...
    Process [label="🏭 LOAD\\n({tout}°C Demand)", shape=cds, fillcolor="#e8f5e9", color="#2e7d32"];
