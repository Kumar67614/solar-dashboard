...
# Calculate annual displaced fuel energy taking into account boiler/heater efficiencies
...
st.markdown('<h3 class="section-header">📋 I. Engineering Sizing Specifications</h3>', unsafe_allowed_html=True)
...
# SECTION 2: BALANCE OF PLANT & PROPOSAL ADDITIONS
st.markdown('<h3 class="section-header">⚙️ II. Balance of Plant (BOP) & System Architecture</h3>', unsafe_allowed_html=True)
...
# SECTION 3: COMMERCIAL PROPOSAL & UTILITY SAVINGS
st.markdown('<h3 class="section-header">💰 III. Commercial Proposal & Financial Viability Analysis</h3>', unsafe_allowed_html=True)
...
# SECTION 4: LIVE CONTROLLER MATRIX (RAW STRING APPLIED TO ELIMINATE SYNTAX WARNINGS)
st.markdown('<h3 class="section-header">🎛️ IV. Real-Time Flow Controller Strategic Profile</h3>', unsafe_allowed_html=True)
col_graph, col_logic = st.columns([1, 1.2])

with col_graph:
    # Build System Energy Performance Scale
